...
# Maps friendly application names to their Splunk queries and metadata.
# `splunk_queries` lists all index/sourcetype pairs to query for this app.
# The first entry is the "primary" used as fallback for single-source operations.
...
APP_REGISTRY: dict[str, dict] = {
    "myaccount": {
        ...
        "splunk_queries": [
            {"index": "mya-caas-nonprod", "sourcetype": "kube:container:mya-dev",      "label": "Web (Dev)",     "env": "dev"},
            {"index": "mya-caas-nonprod", "sourcetype": "kube:container:mya-intg-dev",  "label": "Intg (Dev)",    "env": "dev"},
            {"index": "mya-caas-qa",      "sourcetype": "kube:container:mya-qa",        "label": "Web (QA)",      "env": "qa"},
            {"index": "mya-caas-nonprod", "sourcetype": "kube:container:mya-intg-qa",   "label": "Intg (QA)",     "env": "qa"},
            {"index": "mya-caas-nonprod", "sourcetype": "kube:container:mya-intg-stg",  "label": "Intg (Staging)","env": "stg"},
            {"index": "mya-caas-prod",    "sourcetype": "kube:container:mya-prod",       "label": "Web (Prod)",    "env": "prod"},
            {"index": "mya-caas-prod",    "sourcetype": "kube:container:mya-intg-prod",  "label": "Intg (Prod)",   "env": "prod"},
        ],
        ...
        "pipelines": ["mya", "myaccount"],
    },
    "sdp": {
        "index": "sdp-caas-nonprod",
        "sourcetype": "kube:container:sdp-dev",
        "splunk_queries": [
            {"index": "sdp-caas-nonprod", "sourcetype": "kube:container:sdp-dev", "label": "Dev", "env": "dev"},
            {"index": "sdp-caas-nonprod", "sourcetype": "kube:container:sdp-qa",  "label": "QA",  "env": "qa"},
            {"index": "sdp-caas-nonprod", "sourcetype": "kube:container:sdp-uat", "label": "UAT (Staging)", "env": "stg"},
            {"index": "sdp-caas-prod",    "sourcetype": "kube:container:sdp-prod", "label": "Prod", "env": "prod"},
        ],
        ...
        "pipelines": ["step-data-portal", "edp"],
    },
